...
tab-options-debug-mini-dump = Enable Client Mini Dumps on Crash
tab-options-debug-mini-dump-desc = Enables the creation of mini dumps on crash of the client. ONLY enable if asked to by a developer. May create giant files. Check client logs for location of the dump.
