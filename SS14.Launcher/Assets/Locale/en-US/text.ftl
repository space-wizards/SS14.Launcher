...
tab-options-compatibility-mode-desc = This forces the game to use a different but less superior graphics backend, which is less likely to suffer from driver bugs. Try this if you are experiencing graphical issues or crashes.
